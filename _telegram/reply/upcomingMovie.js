...
module.exports = async function upcomingMovie(chat_id, upcomingMovieInfo) {
    ...
    const text = `${title} will be released on ${format(debutDateTime, 'd MMMM (E)')} and tickets will be available for sales from ${format(new Date('2020-09-21'), 'd MMMM (E)')}. Be sure to check back again! :) Meanwhile, is there anything I can help?`;
